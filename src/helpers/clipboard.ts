...
// ClipboardManager`.
// [20260815_Refactor_DeadClipboardCode] Removed the never-read `this.osascript`
// field (the npm package "osascript" was require()d here but every real
// AppleScript call already spawns the osascript CLI binary), plus the
// zero-caller methods enableMacOSAccessibility / insertTextDirectly.
...
您想现在打开系统设置吗？`;
  ...
  // their zero-renderer-caller IPC channels (copyText above covers writes;
  // the main process reads the clipboard directly where needed).
}
