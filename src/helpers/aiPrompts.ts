// [20260724_TS_BigBang_AiPrompts] Migrated implementation from .js to .ts
// (ADR-010). Was a type re-export stub; now the full prompt-literal
// implementation lives here. `module.exports = { buildPrompt, ... }` became
// named exports.
...
## 示例
输入：今天去了一家新开的咖啡店，环境很好，咖啡也好喝，特别是他们家的拿铁，拉花很漂亮。服务员态度也好，会推荐适合的口味。价格也不贵，一杯拿铁才28块。推荐大家去试试。

输出：
☕️ 发现一家宝藏咖啡店！环境绝了✨

今天被朋友安利了一家新开的咖啡店，一进门就被环境惊艳到了！整体氛围感拉满，超级适合拍照打卡📸

重点夸一下他家的拿铁👇
拉花真的太漂亮了！口感也很丝滑，是我最近喝过最好喝的拿铁没有之一。服务员小哥哥还会根据你的口味偏好推荐，很贴心～

💰 一杯拿铁才28块，这个品质这个价格，性价比真的很高！

如果你们也在找一家环境好、咖啡好喝、不贵的店，一定要来试试！📍

#咖啡店探店 #周末好去处 #宝藏店铺 #咖啡爱好者
...
## 示例
输入：我觉得远程办公效率其实更高，因为不用通勤，省下来的时间可以用来工作。而且在家没有同事打断，专注度更好。但缺点是沟通不够及时，有时候一个简单的问题要等半天。

输出：
**远程办公的效率，取决于你能否管理好"沟通延迟"这个成本。**

先说结论：远程办公的专注度优势是真实的，但它的效率瓶颈不在个人，而在协作。

**个人效率：远程确实更高**

通勤时间省下来是净收益。根据斯坦福大学Nicholas Bloom的研究，远程工作者的生产效率提升了13%，其中相当一部分来自更少的 interruptions 和更长的 uninterrupted 工作时段。在家办公，没有人突然拍你肩膀问问题，你可以连续专注2-3小时——这在办公室几乎不可能。

**协作效率：这是真正的瓶颈**

远程最大的问题不是"不够自律"，而是"沟通延迟"。办公室里10秒能解决的问题，远程可能需要等半天。这不是工具的问题（Slack、飞书都能即时通讯），而是异步沟通天然带来的信息损耗。

**所以关键不是要不要远程，而是怎么降低沟通成本。** 定时同步、文档先行、减少"随时打断"，这三件事做到位，远程的效率优势就能发挥出来。
...
## 示例
输入：最近发现一个提高工作效率的方法，就是把每天最重要的事情放在早上第一件事做。因为早上精力最好，注意力最集中。我试了一周，效率确实提高了不少。
...
## 示例
输入：今天和朋友来吃这家火锅，点了毛肚、鸭肠、嫩牛肉，味道都还不错。毛肚很新鲜，烫几秒就能吃，口感脆。鸭肠一般般，有点老。嫩牛肉腌制过，很嫩。环境一般，比较挤。服务还可以，加汤比较及时。人均120左右。
...
【菜品】
🥩 嫩牛肉：强烈推荐！腌制入味，煮完超嫩，是今晚最佳
🫕 毛肚：很新鲜，七上八下烫完口感脆爽，品质在线
🦆 鸭肠：一般般，有点老，下次不点了

【环境】
环境比较挤，桌子之间距离近，说话要稍微大声点。但还算干净。

【服务】
服务还可以，加汤比较及时，小哥态度也不错。

💰 人均120左右，这个品质算合理。

总结：嫩牛肉值得专门来吃，鸭肠避开就行。适合朋友聚餐，追求环境的话可能不太合适。
