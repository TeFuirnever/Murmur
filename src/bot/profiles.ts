// [20260904_Refactor_BloubEnginePort] Ported from bloub (github.com/jeremy-prt/bloub, MIT), src/bot/profiles.ts.
...
// Radial profiles r(theta) measured off the reference video, pixel by pixel.
// theta = 0 points right and grows clockwise (y points down).
// Unit: radius of the ball at rest = 1.
//
// Generated by tools/extract-profiles.py in the upstream repository — do not
// edit by hand. The generator needs the reference video, which does not travel
// with this port; treat these tables as read-only measurement data.

export const PROFILE_SAMPLES = 64;

export const PROFILES = {
  // egg: same height as the ball, narrowed in width
  // frame 164, measured footprint 1.647 x 2.000
  egg: [
  ...
  // hexagon, point up, very rounded corners
  // frame 174, measured footprint 1.826 x 2.011
  hexagon: [
  ...
  // triangle, point up, very rounded corners
  // frame 190, measured footprint 1.995 x 1.884
  triangle: [
