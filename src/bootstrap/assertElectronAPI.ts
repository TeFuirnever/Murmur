// [20260724_TS_BigBang_AssertElectronAPI] Migrated from .js to .ts (ADR-010).
// Already ESM (`export function`); renamed .js → .ts with no logic changes.
...
// not electronAPI.
export function assertElectronAPI(): boolean {
...
// [20260724_TS_BigBang_AssertElectronAPI] END
